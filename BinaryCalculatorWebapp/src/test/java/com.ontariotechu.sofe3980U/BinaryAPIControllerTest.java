...
public class BinaryAPIControllerTest {
	...
	@Test
    public void addDefaultParameters() throws Exception {
	...
	@Test
    public void addInvalidOperand() throws Exception {
        this.mvc.perform(get("/add").param("operand1","12").param("operand2","1"))//.andDo(print())
            .andExpect(status().isOk())
	...
	@Test
    public void multiplyDefaultParameters() throws Exception {
        this.mvc.perform(get("/multiply"))//.andDo(print())
            .andExpect(status().isOk())
            .andExpect(content().string("0"));
    }
    ...
    public void andDifferentLengths() throws Exception {
        this.mvc.perform(get("/and").param("operand1","111").param("operand2","1"))//.andDo(print())
            .andExpect(status().isOk())
            .andExpect(content().string("1"));
    }
    ...
    public void andWithZero() throws Exception {
        this.mvc.perform(get("/and").param("operand1","1010").param("operand2","0"))//.andDo(print())
            .andExpect(status().isOk())
            .andExpect(content().string("0"));
    }
    ...
    public void orDifferentLengths() throws Exception {
        this.mvc.perform(get("/or").param("operand1","111").param("operand2","1"))//.andDo(print())
            .andExpect(status().isOk())
    ...
    public void orWithZero() throws Exception {
        this.mvc.perform(get("/or").param("operand1","1000").param("operand2","0"))//.andDo(print())
            .andExpect(status().isOk())
